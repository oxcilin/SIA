                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="_account-user" method="POST" class="row g-3 needs-validation login-form" novalidate autocomplete="off">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="login_id" name="login_id" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="modal fade" id="editData<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editDataLabel<?= $no ?>" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="_account-user" method="POST" class="row g-3 needs-validation edit-form" novalidate autocomplete="off">
                                                        <input type="hidden" name="editId" value="<?= $row['id'] ?>">
                                                        <div class="mb-3">
                                                            <label foName<?= $no ?>" class="form-label">Name</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="editLoginID<?= $no ?>" class="form-label">Login ID</label>
                                                            <input type="text" class="form-control" id="editLoginID<?= $no ?>" name="editLoginID" value="<?= $row['login_id'] ?>" required>
                                                            <div class="invalid-feedback">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="_account-user" method="POST" class="row g-3 needs-validation edit-form" novalidate autocomplete="off">
                                                        ...
                                                        <ul>
                                                            <li>ID: <b><?= $row['id'] ?></b></li>
                                                            <li>Name: <b><?= $row['name'] ?></b></li>
                                                            <li>Login ID: <b><?= $row['login_id'] ?></b></li>
                                                        </ul>
                                                    </div>
                                                    <div class="modal-footer">
